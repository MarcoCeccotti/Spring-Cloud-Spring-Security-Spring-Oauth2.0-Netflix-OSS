...
public class Action_log {
	...
	@Column
	private Timestamp time_st = new Timestamp(System.currentTimeMillis());
	...
	public Action_log(String username, String session, String action_name, String action_method, String log_json) {
