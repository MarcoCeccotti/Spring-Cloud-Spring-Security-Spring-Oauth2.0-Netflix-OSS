...
import it.marco.marco.cloud.config.http.service.HttpService;
...
public class InspectionControllerAdvice {
	...
	private String getTextMail(Throwable exception, HttpServletRequest request) {
		...
		return "Utente: " + (session_infos.getUsername() != null ? session_infos.getUsername() : this.httpService.getUsernameFromToken(request)) + 
